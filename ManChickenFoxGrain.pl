...
crossing(st([left,X,left,Z]),st([right,X,right,Z]), bring_chicken_over).
crossing(st([right,X,right,Z]),st([left,X,left,Z]), bring_chicken_back).

crossing(st([left, left, X, Y]),st([right, right, X, Y]), bring_fox_over).
crossing(st([right, right, X, Y]),st([left, left, X, Y]), bring_fox_back).

crossing(st([left, X, Y, left]),st([right, X, Y, right]), bring_grains_over).
crossing(st([right, X, Y, right]),st([left, X, Y, left]), bring_grains_back).
